const Contacts = () => {
    const contacts = [
        ...
        },
        {
            ...
            link: 'https://www.linkedin.com/in/ho-zhang-764234287/'
        },
        {
            name: 'View Projects',
            icon: (
    ...
    return (
        <section id="contacts" className="px-4 py-10 max-w-7xl mx-auto text-center border-t-4 border-gray-300">
            <h2 className="text-3xl mb-8 font-semibold font-serif italic text-[#faa289]">Contacts</h2>
                ...
                {contacts.map((contact, index) => (
                    <a
                        ...
                        className="flex flex-col items-center justify-center p-4 bg-white rounded-lg shadow-md 
                            hover:shadow-lg transition-all duration-300 hover:scale-105 hover:bg-[#a8a4b5]"
                    >
                        <div className="text-gray-600 hover:text-[#678d96] transition-colors">
                            {contact.icon}
                        </div>
